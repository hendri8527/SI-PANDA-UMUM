...
jQuery(document).on("click", "a.google-event", function () {
  ...
  $.ajax({
    ...
    dataType: "html",
    beforeSend: function () {
      jQuery("span#render-google-cal-data").html(
...
jQuery(document).on("click", "a.add-gc-event", function () {
  ...
  $.ajax({
    ...
    dataType: "html",
    beforeSend: function () {
      jQuery("span#render-google-cal-add").html(
        '<div class="text-center"><i class="fa fa-spinner fa-pulse fa-5x fa-fw"></i></div>'
      );
    },
    success: function (html) {
  ...
  jQuery.ajax({
    ...
    success: function (json) {
      ...
      if (json["error"]) {
        ...
        jQuery("span#success-msg").html(
          '<div class="alert alert-success">Your Event has been successfully created.</div>'
        );
      }
    },
    error: function (xhr, ajaxOptions, thrownError) {
